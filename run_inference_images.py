...
def process_video(input_dir, output_dir, model_restoration, factor = 4, self_assemble = True):
    ...
    with torch.inference_mode():
        ...
        for file_path in file_paths:
            ...
            cv2.imwrite(os.path.basename(file_path), restored[0])
...
process_video(images_dir , output_dir, model_restoration, factor = 4, self_assemble = True)
